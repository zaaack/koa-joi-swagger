    ...
    var _ref = (0, _asyncToGenerator3.default)(function* (context, next) {
      if (context.path.startsWith(pathRoot)) {
        ...
        if (context.path === pathRoot && context.method === 'GET') {
          ...
          yield (0, _koaSend2.default)(context, filePath, (0, _extends3.default)({ root: swaggerPath }, sendConfig));
          return;
        }
      }
      return next();
...
const swaggerPath = _path2.default.dirname(require.resolve('swagger-ui/package.json')) + '/dist';